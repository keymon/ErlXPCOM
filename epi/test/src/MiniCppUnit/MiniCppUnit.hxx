...
private:
    ...
    static const char* msgTag_nameOfTest() { return "Test info: "; }
...
\
Test* Factory##ConcreteTestFixture() { return new ConcreteTestFixture; } \
\
class Register##ConcreteTestFixture \
{ \
public: \
	Register##ConcreteTestFixture() \
	{ \
		TestFixtureFactory::theInstance().addFixtureCreator( \
	 Factory##ConcreteTestFixture); \
	} \
}; \
static Register##ConcreteTestFixture _static##ConcreteTestFixture;
